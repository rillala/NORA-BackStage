...
<template>
  <main>
    ...
    <div class="search">
      ...
      <Input class="search-input" search enter-button placeholder="請輸入會員編號進行搜尋" v-model="search" />
    </div>
    ...
    <Table class="table" height="500" :columns="columns" :data="memberList">
      ...
      <template #status="{ row, index }">
        <!--switch btn-->
        <Switch true-color="#13ce66" false-color="#ff4949" v-model="row.openStatus" @on-change="statusChange(index)" />
      </template>
      <template #action="{ row, index }">
        <div v-if="editIndex === index">
          <Button type="text" @click="handleSave(index)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
          ...
          <Button type="text" @click="editIndex = -1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
      ...
      <template>
        ...
        <Button class="btn" type="text" size="small" @click="remove(index)"><svg xmlns="http://www.w3.org/2000/svg"
